...
public class CamerService extends Service implements
    ...
    private Parameters parameters; //policy
    private Bitmap bmp;
    FileOutputStream fo;
        ...
        for ( int camIdx = 0; camIdx < cameraCount; camIdx++ ) {
            ...
            if ( cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_FRONT  ) {
                try {
                    ...
                    Log.e("NEW_TAG", "Camera failed to open: " + e.getLocalizedMessage());
                }
            }
        }
    ...
    private Camera openFrontFacingCameraGingerbread() {
        ...
        for (int camIdx = 0; camIdx < cameraCount; camIdx++) {
            ...
            if (cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_FRONT) {
                try {
                    cam =Camera.open(camIdx);
                    // me added this code to mute capture photo sound
    ...
    private synchronized void takeImage(Intent intent) {
        ...
        if (checkCameraHardware(getApplicationContext())) {
            ...
            if (isFrontCamRequest) {
                ...
                Log.i("TAG","I am here if condition");
                // set flash 0ff
                FLASH_MODE = "off";
                // only for gingerbread and newer versions
                if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) { //9
                    Log.i("TAG","I am here if condition2");

                    mCamera = openFrontFacingCameraGingerbread();
                    //mCamera=openFrontFacingCamera();
                    //mCamera = Camera.open(Camera.CameraInfo.CAMERA_FACING_FRONT);
                    if (mCamera != null) {
                        Log.i("TAG","I am here if condition3");
                        ...
                        Log.i("TAG","I am here if condition4");
                        mCamera = null;
                        handler.post(new Runnable() {
/////////////////////////////////////////////////////////
                            @Override
